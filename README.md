...
| Model | MAE | RMSE | MAPE |
|---|---|---|---|
| Seasonal Naive | *fill in* | *fill in* | *fill in* |
| Moving Average | *fill in* | *fill in* | *fill in* |
| ARIMA(2,1,2) | *fill in* | *fill in* | *fill in* |
| SARIMA(2,1,2)(1,1,1,7) | *fill in* | *fill in* | *fill in* |
